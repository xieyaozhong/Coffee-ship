(() => {
  ...
  const encounters = [
    ...
    ['失落航海圖','美人魚遞來一張被海水泡軟的圖，上面畫著不存在的島。','🗺️','失落航海圖','treasure'],
    ...
    ['瓶中歌詞','她留下漂流瓶，裡面裝著一首由珍珠光芒寫成的歌。','🎼','美人魚歌詞漂流瓶','lyrics'],
    ['深海藍寶','她指向海面，浪花中浮出一顆深藍色寶石。','🔷','深海藍寶','treasure'],
    ['無聲的微笑','她只是看著你，像知道所有沒有說完的心意。','💙','無聲祝福','buff'],
    ['泡沫回音','她化成一串泡泡離開，其中一顆泡泡包著一張會唱歌的紙。','🫧','泡沫歌詞瓶','lyrics']
  ];
