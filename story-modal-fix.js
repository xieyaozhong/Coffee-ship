(() => {
  ...
  const storyIds = ['lanarCard', 'arielCard', 'islandCard', 'blackbeardCard', 'madPriestCard'];
  ...
  function addStyle() {
    ...
    style.textContent = `
      ...
      @media(max-width:760px){
        ...
        #lanarCard:not(.hidden),#arielCard:not(.hidden),#islandCard:not(.hidden),#blackbeardCard:not(.hidden),#madPriestCard:not(.hidden){position:fixed!important;left:50%!important;top:36%!important;transform:translate(-50%,-50%)!important;z-index:13000!important;width:min(90vw,390px)!important;max-height:56dvh!important;overflow-y:auto!important;pointer-events:auto!important;padding:14px!important}
        #lanarCard:not(.hidden) .lanar-text,#arielCard:not(.hidden) .ariel-text,#islandCard:not(.hidden) .island-text,#blackbeardCard:not(.hidden) .blackbeard-text,#madPriestCard:not(.hidden) .mad-priest-text{max-height:36dvh!important;overflow-y:auto!important}
      }
    `;
