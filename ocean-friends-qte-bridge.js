(() => {
  ...
  function openOcean() {
    return window.COFFEE_SHIP_OCEAN_FRIENDS_QTE?.open?.() || false;
  }
  ...
  function patch() {
    ...
    const replacement = event => {
      ...
      if (first === 'ocean') setTimeout(openOcean,80);
      ...
      if (Math.random() < secondaryChance) {
        ...
        if (second === 'ocean') setTimeout(openOcean,700);
